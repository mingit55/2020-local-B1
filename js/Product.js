class Product {
    ...
    storeRender(){
        if(!this.storeElem){
            this.storeElem = this.app.createElem(`<div class="col-lg-4 col-md-4 col-12 mb-5">
    ...
    cartRender(){
        let {photo, name, brand, price} = this.initial_data;
        ...
        if(!this.cartElem) {
            this.cartElem = this.app.createElem(`<div class="cart-item">
                                                    ...
                                                    <div class="count">
                                                        <div class="text-center">
                                                            <input type="number" class="i-count c-count" min="0" value="${this.buyCount}">
                                                        </div>
                                                    </div>
                                                    <div class="total">
                                                        <div class="text-center">
